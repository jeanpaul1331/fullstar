...
// Function to log requests along with system details
...
System Info: ${JSON.stringify(systemInfo, null, 2)}\n\n`;
    ...
    const logFilePath = path.join(__dirname, 'log_info.txt');
...
const server = http.createServer(async (req, res) => {
    await logRequest(req); // Log each request with system info
